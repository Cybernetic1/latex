...
\else
	\documentclass[14pt, orivec]{extarticle} % 12pt, 14pt, 17pt, 20pt
\fi
\usepackage{parskip}
\usepackage{amsmath}
...
\ifdefined\chinchin
	...
	\setCJKmainfont[BoldFont=Alibaba_PuHuiTi_Regular.ttf, ItalicFont=gkai00mp.ttf,Path={/usr/share/fonts/truetype/Alibaba PuHuiTi/}]{Alibaba_PuHuiTi_Light.ttf}
